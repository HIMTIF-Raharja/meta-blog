...
<body>
    ...
    <form class="m-auto mt-4" style="width: 80%;" action="add_siswa.php" method="post" name="form1">
        ...
        <input type="tel" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Metaverse Image (ex: tmc1)" name="image">
        </div>
        
        <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Location:</label>
        
        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Redirect to.. (ex: metaverse/fantasy)" name="location">
        </div>
